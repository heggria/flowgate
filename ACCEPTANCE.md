...
最新复核见 [2026-09-14 全需求与实际运行复核](REVIEW_2026-09-14.md)。下文各日期历史证据不能直接用于证明当前构建。0.3.2 已支持管理员批准的免费本机辅助服务，使用方式见 [LOCAL_DEVELOPMENT.md](LOCAL_DEVELOPMENT.md)。旧文中的证书延期仅适用于 Apple 签名正式分发；本机特权能力及剩余实测边界以最新复核为准。
